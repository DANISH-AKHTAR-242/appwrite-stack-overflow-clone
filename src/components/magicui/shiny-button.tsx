"use client";
import { type MotionProps, motion } from "framer-motion"; // Fix 1: Changed AnimationProps to MotionProps

// This object now correctly uses the MotionProps type
...
// Fix 2: Added a proper type for the component's props
